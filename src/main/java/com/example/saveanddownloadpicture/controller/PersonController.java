package com.example.saveanddownloadpicture.controller;

import com.example.saveanddownloadpicture.model.ImageFile;
import com.example.saveanddownloadpicture.repository.ImageFileRepository;
...
public class PersonController {
    ...
    public ImageFile getImage(@PathVariable("imageName") String imageName) throws IOException {
        final Optional<ImageFile> retrievedImage = imageFileRepository.findByName(imageName);
        return new ImageFile(retrievedImage.get().getName(), retrievedImage.get().getType(),
